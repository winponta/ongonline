#ifndef _NITGEN_NBioAPI_H
#define _NITGEN_NBioAPI_H
...
extern "C" {
   ...
   NBioAPI_RETURN NBioAPI NBioAPI_RollLiveCapture (
                                          NBioAPI_HANDLE                  hHandle,
                                          NBioAPI_ROLL_HANDLE_PTR         phRollHandle,
                                          NBioAPI_SINT32                  nTimeout,
                                          const NBioAPI_WINDOW_OPTION_PTR pWindowOption);
                                          
   NBioAPI_RETURN NBioAPI NBioAPI_RollComposeCapture (
                                          NBioAPI_HANDLE                  hHandle, 
                                          NBioAPI_ROLL_HANDLE_PTR         phRollHandle,
                                          NBioAPI_FIR_PURPOSE             nPurpose,
                                          NBioAPI_FIR_HANDLE_PTR          phCapturedFIR,
...
#ifndef _WIN32_WCE
   /* Skin Function */
   NBioAPI_BOOL NBioAPI NBioAPI_SetSkinResource(
                                          LPCTSTR szResPath);
#endif
   ...
   typedef NBioAPI_RETURN (NBioAPI *FP_NBioAPI_RollLiveCapture)(
                                          NBioAPI_HANDLE                  hHandle,
                                          NBioAPI_ROLL_HANDLE_PTR         phRollHandle,
                                          NBioAPI_SINT32                  nTimeout,
                                          const NBioAPI_WINDOW_OPTION_PTR pWindowOption);
                                          
   typedef NBioAPI_RETURN (NBioAPI *FP_NBioAPI_RollComposeCapture)(
                                          NBioAPI_HANDLE                  hHandle, 
                                          NBioAPI_ROLL_HANDLE_PTR         phRollHandle,
                                          NBioAPI_FIR_PURPOSE             nPurpose,
                                          NBioAPI_FIR_HANDLE_PTR          phCapturedFIR,
...
#ifndef _WIN32_WCE
   /* Skin Function */
   typedef NBioAPI_BOOL (NBioAPI *FP_NBioAPI_SetSkinResource)(
                                          LPCTSTR szResPath);
#endif
