...
class Assistance_EventsController extends Zend_Controller_Action {
    ...
    public function listAction() {
        if ($this->_isUserAllowed(null, null)) {
            ...
            $events = $domain->getAllWithPagination(Zend_Auth::getInstance()->getIdentity()->appaccount_id, 'event_date desc', $paginator, $params);
    ...
    public function searchExistRegisterAction() {
        ...
        $pd = new Assistance_Domain_Event();
