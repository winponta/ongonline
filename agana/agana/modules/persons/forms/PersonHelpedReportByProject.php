 ...
 */
class Persons_Form_PersonHelpedReportByProject extends Twitter_Bootstrap_Form_Horizontal {
    ...
    public function init() {
        ...
        $el = $formutil->addElementDate($this, array(
            'name'          => 'date_in_start',
            'label'         => 'Data de entrada à partir',
            'default'       => false,
        ...
        $this->addDisplayGroup(array(
            ...
            'date_in_start','date_in_end','date_out_start','date_out_end',
            'summarized',
                ), 'project', array()
            );

//        $this->addDisplayGroup(
//                array('print'), 'actions-end', array(
