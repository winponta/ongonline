 ...
 */
class Location_Form_CountryDelete extends Agana_Form_Delete_Abstract {
    ...
    public function __construct($model) {
        $dataMessage = $this->getView()->translate('Are you sure you want to delete this country: ') . $model->getName() . '?';
