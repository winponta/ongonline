 ...
 */
class Staff_Form_Expertisearea extends Twitter_Bootstrap_Form_Horizontal {
    ...
    private function _addElementName() {
        ...
        if ($this->_action == self::ACTION_ADD) {
            $this->getElement('name')->addValidator('Db_NoRecordExists', false, array('table' => 'expertise_area', 'field' => 'name',)
            );
        }
    }
