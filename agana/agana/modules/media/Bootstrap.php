...
class Media_Bootstrap extends Zend_Application_Module_Bootstrap {
    ...
    protected function _initModuleConfig() {
        // load ini file
        Agana_Util_Bootstrap::loadModuleIni(dirname(__FILE__) . '/configs/module.ini', 'media', $this);
    }
    ...
    function _initViewHelpers() {
        /**
         * Add the Media View helpers path
         */
        $view = Zend_Layout::getMvcInstance()->getView();
        $view->addHelperPath(
                __DIR__ . '/views/helpers', 'Media_View_Helper'
        );
    }
