...
/**
 * Based on Ini_Struct class from http://codeaid.net/php/parse-ini-file-into-a-multi-dimensional-array
...
/**
 * Allows multi-dimensional ini files.
 *
